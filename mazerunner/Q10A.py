...
# print(final_maze)
# final_maze = final_maze[:-1]
final_path_length = pathGen(ltn)+1
final_path.append(0)
final_path.reverse()
final_path.append((dim**2) - 1)
print (final_path_length)#length of the solution path
print (nodes_expanded)#total nodes expanded during runtime
print (max_fringe_size)#maximum size of the fringelist 
print (final_path)#solution path traversed without 0 and 99
